      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          leading: FlutterFlowIconButton(
            ...
            onPressed: () async {
              logFirebaseEvent('MAIN_CUSTOMER_LIST_arrow_back_rounded_IC');
              context.pop();
            },
          ),
          title: Text(
            FFLocalizations.of(context).getText(
              '6ziufcam' /* Investments */,
            ),
                                                                        ...
                                                                        if (responsiveVisibility(
                                                                          ...
                                                                          Expanded(
                                                                            child:
                                                                              ...
                                                                              child: Text(
                                                                                formatNumber(
                                                                                  listViewFundsRecord.raisedMoney,
                                                                                  formatType: FormatType.compact,
                                                                                  currency: '\$',
                                                                                ),
